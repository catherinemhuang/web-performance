...
p.draw = function() {
  ...
  if (window.foods.length === 0 && window.gameState === "whoami") {
...
// ───────── WHO AM I SCENE ─────────
function drawWhoAmI() {
  if (!window.whoAmIgenerated) {
    window.foods = [];
    generateTextPoints("WHO AM I?");
    window.whoAmIgenerated = true;
  }
